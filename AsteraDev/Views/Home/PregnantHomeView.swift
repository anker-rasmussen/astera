...
struct PregnantHomeView: View {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            Text("We're counting pregnancy weeks now, not cycle days. Your full cycle history stays exactly where it is.")
    ...
    private var setupPrompt: some View {
        VStack(alignment: .leading, spacing: AsteraSpacing.md) {
            ...
            Text("We'd need your last period date.")
                .font(.asteraSerif(22))
                .foregroundStyle(AsteraColor.ink)
            Text("We can't count weeks without it. Open History and tap the day your last period started.")
                .font(.asteraSerifItalic(14))
                .foregroundStyle(AsteraColor.iron)
                .fixedSize(horizontal: false, vertical: true)
                .lineSpacing(2)
